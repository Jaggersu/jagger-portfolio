                    ...
                    {step === 'auth' ? (
                        <div className="space-y-4">
                            ...
                            <button
                                ...
                                className="w-full sm:w-auto flex items-center justify-center gap-2 py-2.5 px-6 bg-white text-black font-bold text-[11px] tracking-widest rounded-lg hover:bg-zinc-200 transition-colors disabled:opacity-50"
                            >
