            ...
            >
              ...
              <div className="relative text-center w-full select-none cursor-default group py-4">
                ...
                <div className="relative inline-block w-full max-w-[320px] transition-transform duration-500 group-hover:scale-[1.005]">
                  ...
                  <svg width="316" height="194" viewBox="0 0 316 194" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-full max-w-[320px] h-auto mx-auto mb-2 relative z-0">
                    ...
                    <path d="M295.684 107.387C294.628 107.387 293.846 107.093 293.338 106.504C292.831 105.894 292.577 105.123 292.577 104.189C292.577 103.234 292.922 102.3 293.612 101.386C294.303 100.452 295.318 99.4876 296.658 98.4926C298.019 97.4975 299.156 97 300.07 97C300.537 97 300.862 97.1117 301.045 97.3351C301.228 97.5381 301.4 97.6701 301.563 97.731C301.745 97.792 301.837 97.9747 301.837 98.2793C301.837 98.5839 301.755 98.8073 301.593 98.9495C301.431 99.0713 301.014 99.6094 300.344 100.564C299.694 101.498 299.309 102.117 299.187 102.422C299.512 102.747 299.674 103.255 299.674 103.945C299.674 104.615 299.278 105.356 298.486 106.169C297.694 106.981 296.76 107.387 295.684 107.387Z" fill="white" />
                    <path d="M248.374 83.0547H212.592V116.913C212.592 119.863 213.041 122.749 213.938 125.57C214.964 128.392 216.632 130.701 218.94 132.496C221.377 134.292 224.584 135.189 228.559 135.189C234.587 135.189 238.691 133.522 240.871 130.188C243.18 126.725 244.398 122.877 244.526 118.645C244.142 118.26 243.949 117.747 243.949 117.105C243.949 115.439 244.783 114.605 246.45 114.604C248.117 114.604 248.951 115.438 248.951 117.105C248.951 117.747 248.759 118.26 248.374 118.645C248.117 122.107 247.348 125.378 246.065 128.456C244.783 131.534 242.731 134.099 239.909 136.151C237.216 138.075 233.433 139.037 228.559 139.037C223.558 139.037 219.581 137.947 216.632 135.767C213.81 133.586 211.758 130.829 210.475 127.494C209.321 124.031 208.744 120.504 208.744 116.913V76H212.592V79.207H244.526V76H248.374V83.0547ZM212.592 72H208.744V68H212.592V72ZM248.374 72H244.526V68H248.374V72ZM228.559 39C233.561 39.0001 237.472 40.0904 240.294 42.2705C243.244 44.4508 245.296 47.2084 246.45 50.543C247.733 53.8775 248.374 57.4047 248.374 61.124V64H244.526V61.124C244.526 58.1743 244.077 55.3524 243.18 52.6592C242.282 49.8376 240.679 47.5289 238.37 45.7334C236.062 43.8098 232.791 42.8477 228.559 42.8477C224.584 42.8477 221.377 43.8096 218.94 45.7334C216.632 47.5289 214.964 49.8376 213.938 52.6592C213.041 55.3524 212.592 58.1743 212.592 61.124V64H208.744V61.124C208.744 57.4048 209.321 53.8775 210.475 50.543C211.758 47.2084 213.81 44.4508 216.632 42.2705C219.581 40.0902 223.558 39 228.559 39Z" fill="white" />
                  ...
                  <svg width="316" height="194" viewBox="0 0 316 194" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-full max-w-[320px] h-auto mx-auto mb-2 absolute inset-0 z-10 pointer-events-none">
                    ...
                    <path d="M254.413 147.2H256.653V166.08H262.509V168H254.413V147.2Z" stroke="#FF5500" strokeWidth="1.2" strokeDasharray="3 3" opacity={hoveringTitle ? "0.85" : "0.4"} />
