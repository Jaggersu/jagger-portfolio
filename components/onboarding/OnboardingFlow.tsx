...
const CONTRACT_CLAUSES = [
    ['01', '服務範疇', '乙方依客戶所選方案，提供對應之視覺設計、網頁建置或 SaaS 產品開發等服務。具體交付項目、規格與時程，以本線上系統生成之確認數據為準。超出本合約約定範圍之額外需求須另行報價。'],
    ['02', '修改次數與範圍變更', '本案交付包含最多 2 次微調修正。超出次數之修改，或因客戶需求變更導致工作範圍擴大者，乙方得另行報價。客戶如於確認稿後要求重大方向調整，視同新增需求處理。'],
    ['03', '費用、付款與執行時程', '本合約服務費用總計為 [[AMOUNT]]，執行時程為 [[TIMELINE]]（自客戶完整提供執行所需素材之次日起算）。本服務採 100% 線上全額預付制，客戶完成付款後，合約始生履約效力，乙方即安排時程執行。'],
    ['04', '智慧財產權歸屬', '客戶完成全額付款後，乙方將本專案之最終定稿著作財產權完整移轉予客戶。乙方保留：(a) 作品集展示與參展權；(b) 工作流程中所使用之通用框架、元件庫及可重用程式碼之所有權。未獲客戶採用之提案稿，著作權仍歸乙方所有。'],
    ['05', '客戶素材與侵權責任', '客戶提供之文字、圖片、商標及其他素材，應保證合法取得且不侵害任何第三方之智慧財產權；因客戶素材引發之法律責任由客戶自行承擔。乙方所使用之正版圖庫及字型授權，僅限本專案用途，客戶不得另作他用或轉授權。'],
    ['06', '合約終止與退款', '本案因屬客製化按件計酬服務，付款後若乙方已開始執行：(a) 客戶主動終止時，已支付款項不予退還，乙方應交付終止前已完成之階段性半成品；(b) 乙方主動終止時，應於 7 個工作天內依未完成比例退還對應款項。'],
    ['07', '保密條款', '雙方同意對合作過程中取得之商業機密、未公開素材、客戶資料予以嚴格保密；未經對方書面同意，不得向第三方揭露。保密義務於合約終止後繼續存續 3 年。'],
    ['08', '不可抗力', '因天災、政府法規變動、網路基礎設施故障、第三方服務中斷（如雲端平台、金流閘道）等不可抗力事件，導致乙方無法如期履約者，乙方得就受影響部分順延時程，雙方均不得以此為由要求違約賠償。'],
    ['09', '準據法與爭議解決', '本合約受中華民國法律管轄。雙方應先以協商方式解決爭議；協商不成時，同意以臺灣桃園地方法院為第一審管轄法院。'],
] as const;
